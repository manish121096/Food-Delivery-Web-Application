        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <textarea name="address" rows="10" placeholder="Enter your Street, City, Country" class="input-responsive" required></textarea>
            ...
            <?php
                //check wheather submit button is clicked or not
                 if(isset($_POST['submit']))
                 {
                     ...
                     $status="Ordered"; //oredered, on delivery, delivered, cancel oreder
                     ...
                     if($res2==true)
                     {
                         ...
                         $_SESSION['order']="<div class='success text-center'>Food ordered succussfully.</div>";
                         header('location:'.SITEURL);
                     }
                     else
                     {
